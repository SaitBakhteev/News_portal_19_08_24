...
# ACCOUNT_EMAIL_VERIFICATION='mandatory' # прежде, чем новый пользователь захочет войти в приложение,
                # он должен подтвердить почту, на котрую придет соответствующая ссылка ссылка
